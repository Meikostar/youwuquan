...
public class NavigationBar extends LinearLayout implements View.OnClickListener {
    ...
    public NavigationBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        barStyle.left_imgId = a.getResourceId(R.styleable.NavigationBar_navigationLeft_img, R.drawable.back);
        barStyle.right_img = a.getResourceId(R.styleable.NavigationBar_right_img, R.drawable.back);
...
//        txt_right.setVisibility(VISIBLE);
//        txt_right.setText(barStyle.right_txt);
//        txt_right.setTextColor(getResources().getColor(R.color.color_primary_yellow));
