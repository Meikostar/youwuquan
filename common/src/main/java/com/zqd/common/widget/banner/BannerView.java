package com.zqd.common.widget.banner;
...
import com.zqd.common.utils.DisplayUtil;
...
public class BannerView extends RelativeLayout implements BannerAdapter.ViewPagerOnItemClickListener {
     ...
     * 图片轮播需要传入参数
     */
    public void build(List<BannerEntity> list, LinearLayout linearLayout, ViewPager viewPager) {
        points = linearLayout;
