...
public class LoadingDialog {
    ...
    private static LoadingView loadingText;
    ...
    public static Dialog showDialogForLoading2(Activity context, String msg) {
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_loading_view, null);
        loadingText = (LoadingView)view.findViewById(R.id.loadView);
        loadingText.setLoadingText(msg);
        mLoadingDialog = new Dialog(context, R.style.CustomProgressDialog);
        mLoadingDialog.setCancelable(true);
        mLoadingDialog.setContentView(view, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT));
        mLoadingDialog.show();
