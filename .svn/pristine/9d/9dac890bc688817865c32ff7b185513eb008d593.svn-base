...
//        }
    ...
    public static boolean isZipNO(String zipString){
        String str1 = "^[1-9][0-9]{5}$";
        return Pattern.compile(str1).matcher(zipString).matches();
    }
    ...
    public static int getStringWidth(EditText view){
        TextPaint paint = view.getPaint();
        return (int) Layout.getDesiredWidth(view.getText().toString().trim(), 0, view.getText().length(), paint);
    }
}
