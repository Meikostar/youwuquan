    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (mLists.get(position).getType()) {
            ...
            case TEXT_TYPE:
                ...
                //头像
                Glide.with(context).load(bean.getModel_Icon()).transform(new GlideCircleTransform(context)).into(text_holder.mIcon);
                //用户名
                text_holder.mName.setText(bean.getModel_Name());
                //时间
            ...
            case IMAGE_TEXT_TYPE:
                ...
                //头像
                Glide.with(context).load(bean.getModel_Icon()).transform(new GlideCircleTransform(context)).into(textIamge_holder.mIcon);
                //用户名
                textIamge_holder.mName.setText(bean.getModel_Name());
                //时间
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.dashang_dongtai_pic:
                    LogUtils.e("图文 item  点击了打赏" + bean.getModel_Name() + "的收钱号" + bean.getModel_PayID());
                    break;
                case R.id.icon_item_image:
                    context.startActivity(new Intent(context, ModelInfoActivity.class));
                    break;
                ...
                case R.id.cardView:
                    ...
                    LogUtils.e( "putExtras" + bean.toString());
