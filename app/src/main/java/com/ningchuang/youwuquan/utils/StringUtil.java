...
//    public static String isLegalPwd(String pwd, String aginpwd, Context context){
//        errorMsg="";
//        if(pwd.equals("") || pwd == null){
//            errorMsg = context.getString(R.string.mimanull);
//
//        }
//        if(pwd.length() <6)
//        {
//            errorMsg = context.getString(R.string.geshicw);
//
//        }
//        if (!pwd.matches("^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,16}$")) {
//            errorMsg = context.getString(R.string.mimabixushizm);
//
//
//        }
//        if(!aginpwd.equals(pwd))
//        {
//            errorMsg = context.getString(R.string.liangcimabyz);
//
//        }
//        return errorMsg;
//    }
//    public static String isLegalPwd(String pwd, Context context){
//        if(pwd.equals("") || pwd == null){
//            errorMsg = context.getString(R.string.mimanull);
//
//        }
