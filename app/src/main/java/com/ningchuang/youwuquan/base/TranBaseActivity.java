package com.ningchuang.youwuquan.base;
...
import com.zqd.common.utils.StatusBarUtil;
...
//    }
//}
public abstract class TranBaseActivity<T extends BasePresenter, E extends BaseModel> extends AppCompatActivity implements NavigationBar.NavigationBarListener  {
    ...
    protected void onStart() {
        super.onStart();
        DensityUtil.setTranslucentStatus(this, true);
    }
...
//        SetTranslanteBar();
    ...
    public void startProgressDialog() {
        LoadingDialog.showDialogForLoading(this,"加载中，请稍后...",true);
    }
