...
public class YunUploadViewBig extends LinearLayout {
    ...
    public YunUploadViewBig(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public YunUploadViewBig(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public YunUploadViewBig(Context context) {
        super(context);
        init(context);
    }
    ...
    private void init(Context context){
        mContext = context;
        mView = LayoutInflater.from(context).inflate(R.layout.view_upload_images,this);
